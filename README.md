...
### 실험 결과, 전략 평가
    ...
    #step 1700 벽 사용 학습
    #step 3900 벽 설치 후 가만히 있음
    #step 4100 벽 설치 후 도망가기 학습
    #step 5300 벽으로 막기 힘들게 술래가 양쪽으로 나뉘어지려는 경향을 보임 
    #step 5400 벽에 의해 나뉘면 한명이 반대로 감, greed true로 해도 한 움직임 반복이 아닌 여러 움직임 보임
    #step 17200 도망자가 벽에서 멀리 떨어져서 상황을 파악하려함
    #step 18200 유령이 한곳(좌상단)에서 대기(매복) 시야의 맹점(직진, 대각밖에 못봄)을 이해하고 전략에 사용, 다른 술래가 움직일때는 가만히 있는게 도움이 됨을 학습
    #step 22000 현시점 최종
